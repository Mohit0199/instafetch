...
import { AdsterraBanner, NativeBannerAd, SkyscraperAd } from './components/Ads';
import {
      ...
      <div className="flex-grow">
        ...
        {currentPage === 'home' && (
          <div className="flex justify-center gap-4 relative">
            ...
            <div className="hidden xl:block w-[160px] sticky top-20 h-fit mt-8 flex-shrink-0">
              <SkyscraperAd />
            </div>
            ...
            <div className="w-full max-w-4xl flex-shrink-0">
              ...
              {/* --- ADSTERRA CENTER BANNERS (Side by Side) --- */}
